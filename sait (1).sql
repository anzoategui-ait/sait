...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 14-06-2022 a las 23:21:48
...
(2, 2022, 6, '36.71', 2, 'Bolsa de Alimento'),
...
(7, 2022, 3, '19.59', 7, 'Audiencia con el gobernador');
...
(1, 2022, 9, '57.41', 1, 'Gestion Social'),
(2, 2022, 10, '65.59', 2, 'Gestion Interna'),
...
(1, 2022, 10, '52.60', 10, '52.60', 2, '10.52', 10075, 'Pedro, Perez', '1648655167 avatar-mujer-2.jpg', '2022-06-06'),
(2, 2022, 6, '31.56', 6, '31.56', 1, '5.26', 10077, 'Jose luis, Herrera', '1648827761 avatar-mujer-2.jpg', '2022-06-06'),
(3, 2022, 3, '15.78', 3, '15.78', 2, '10.52', 10079, 'usuario, operador', '1652720391 ag03.jpg', '2022-06-06');
...
(1, 1, 'Anaco', 8, '42.11', 2022),
(2, 2, 'Aragua', 0, '0.00', 2022),
(3, 3, 'Sotillo', 0, '0.00', 2022),
(4, 4, 'Bolivar', 6, '31.58', 2022),
...
--
ALTER TABLE `asignacion`
  MODIFY `asignacion_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;

--
-- AUTO_INCREMENT de la tabla `bitacora`
--
ALTER TABLE `bitacora`
  MODIFY `bitacora_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1568;
...
--
ALTER TABLE `procesar`
  MODIFY `procesar_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;
...
--
ALTER TABLE `solicitud`
  MODIFY `solicitud_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;

--
-- AUTO_INCREMENT de la tabla `solicitud_actividad`
--
ALTER TABLE `solicitud_actividad`
  MODIFY `sol_act_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=39;

--
-- AUTO_INCREMENT de la tabla `solicitud_direccion`
--
ALTER TABLE `solicitud_direccion`
  MODIFY `solicitud_direccion_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;

--
-- AUTO_INCREMENT de la tabla `solicitud_gabinete`
--
ALTER TABLE `solicitud_gabinete`
  MODIFY `solicitud_gabinete_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;
