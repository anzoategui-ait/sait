...
if ($gabinete_id == "" || $fecha_inicio == "" || $fecha_fin == "") {
    ...
    if ($gabinete_id == 0) {
        ...
        $gabinetes = $ins_gabinete->datos_direccion_controlador("Todos", 0);
    } else {
        //Todos los estados para una unica gabinete
        $gabinetes = $ins_gabinete->datos_direccion_controlador("Unico", $ins_gabinete->encryption($gabinete_id));
    }
    ...
    $pdf->Cell(116, 8, utf8_decode('DIRECCION'), 1, 0, 'C', false);
    ...
    if ($gabinetes->rowCount() > 0) {
        ...
        foreach ($gabinetes as $rows) {
            ...
            $recurrencia_gabinete= $ins_home->obtener_recurrencia_fecha_controlador("DireccionHome", $rows['direccion_id'], $fecha_inicio, $fecha_fin);
            ...
            if ($porcentante_recurrencia_gabinete!= 0) {
                    ...
                    $pdf->Cell(116, 6, utf8_decode($rows['direccion_nombre']), 1, 0, 'L');
