...
<body id="mimin" class="dashboard">
    <?php
		...
		if($vistas=="login" || $vistas=="404" || $vistas=="login-club"){
                   ...
                   if(!isset($_SESSION['token_tor']) || !isset($_SESSION['usuario_tor']) || !isset($_SESSION['privilegio_tor']) || !isset($_SESSION['id_tor'])){
                       if($vistas!="./vistas/contenidos/solicitud-view.php" && $vistas!="./vistas/contenidos/consulta-view.php" && $vistas!="./vistas/contenidos/requisitos-view.php"){
	...
	?>
      ...
      <?php 
      if($vistas!="./vistas/contenidos/solicitud-view.php" && $vistas!="./vistas/contenidos/consulta-view.php" && $vistas!="./vistas/contenidos/requisitos-view.php"){
          include "./vistas/inc/NavHeader.php";
      }else{
      ...
      <div class="container-fluid mimin-wrapper">
          ...
          <!-- start:Left Menu -->
            <?php 
            if($vistas!="./vistas/contenidos/solicitud-view.php" && $vistas!="./vistas/contenidos/consulta-view.php" && $vistas!="./vistas/contenidos/requisitos-view.php"){
                include "./vistas/inc/NavLeftMenu.php";
            }
          ...
          <!-- start: right menu -->
           <?php  
           if($vistas!="./vistas/contenidos/solicitud-view.php" && $vistas!="./vistas/contenidos/consulta-view.php" && $vistas!="./vistas/contenidos/requisitos-view.php"){
               include "./vistas/inc/NavRightMenu.php"; 
           }
           ?>
          <!-- end: right menu -->
      ...
      <?php 
      if($vistas!="./vistas/contenidos/solicitud-view.php" && $vistas!="./vistas/contenidos/consulta-view.php" && $vistas!="./vistas/contenidos/requisitos-view.php"){
          include "./vistas/inc/NavMobile.php";
      }?>
       <!-- end: Mobile -->
