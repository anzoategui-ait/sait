//selecciona todos los formularios que se encuentran en una vista
const formularios_ajax = document.querySelectorAll(".FormularioAjax");
//previene el envio del formulario al submit es decir para que no
//se redirija o recargue la misma pagina e.preventDefault()
...
//Para estar pendiente de cada evento generado por algun formulario
formularios_ajax.forEach(formularios => {
    formularios.addEventListener("submit", enviar_formulario_ajax);
});
//crear una funcion para recibir un arreglo de datos o json
function alertas_ajax(alerta) {
    ...
    }else if (alerta.Alerta === "recargarlink") {
        Swal.fire({
            title: alerta.Titulo,
            text: alerta.Texto,
    ...
    }else if (alerta.Alerta === "linkredireccionar") {
        Swal.fire({
            title: alerta.Titulo,
            text: alerta.Texto,
            footer: alerta.Footer,
