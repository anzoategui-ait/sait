    ...
    <div class="mimin-mobile-menu-list">
        <div class="col-md-12 sub-mimin-mobile-menu-list animated fadeInLeft">
            <ul class="nav nav-list">
                <li class="ripple">
                    <a href="<?php echo SERVERURL;?>home/"><span class="fa-bar-chart-o fa"></span> Resumen 
            ...
            if ($_SESSION['privilegio_tor'] == 1 && $_SESSION['tipo_tor'] == 1) {
             ...
             <!-- SOLICITUDES -->
                ...
                <li class="ripple"><a class="tree-toggle nav-header"><span class="fa-cogs fa"></span> Configuracion <span class="fa-angle-right fa right-arrow text-right"></span> </a>
                    <ul class="nav nav-list tree">
