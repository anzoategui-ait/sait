...
<div class="panel box-shadow-none content-header">
    <div class="panel-body">
        <div class="col-md-12">
            <h3 class="animated fadeInLeft">Bitacora / Buscar</h3>
...
<?php
if (!isset($_SESSION['busqueda_bitacora']) && empty($_SESSION['busqueda_bitacora'])) {
//el empty() para saber si esta vacia y el isset() para saber si esta definida
            ...
            <div class="container-fluid">
                    ...
                    <div class="col-12 col-md-12">
                        <div class="form-group form-animate-text">
                            ...
                            <span class="bar"></span>
                            <label for="inputSearch" class="bmd-label-floating text-center">¿Qué bitacora estas buscando?</label>
                        </div>
                    </div>
                    <div class="col-12">
            ...
            <div class="container-fluid">
                    ...
                    <div class="col-12 col-md-12">
                        <p class="text-center" style="font-size: 20px;">
                            Resultados de la busqueda <strong>"<?php echo $_SESSION['busqueda_bitacora']; ?>"</strong>
                        </p>
                    </div>
                    <div class="col-12">
    ...
    <div class="container-fluid">
        ...
        echo $ins_bitacora->paginador_bitacora_controlador($pagina[1], 10, $_SESSION['privilegio_tor'], $pagina[0], $_SESSION['busqueda_bitacora']);
        ?>
    </div>
