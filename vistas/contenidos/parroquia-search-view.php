...
<div class="panel box-shadow-none content-header">
    <div class="panel-body">
        <div class="col-md-12">
            <h3 class="animated fadeInLeft">Parroquia / Buscar</h3>
...
<?php
if (!isset($_SESSION['busqueda_parroquia']) && empty($_SESSION['busqueda_parroquia'])) {
//el empty() para saber si esta vacia y el isset() para saber si esta definida
    ?>
        ...
        <form class="cmxform FormularioAjax" action="<?php echo SERVERURL; ?>ajax/buscadorAjax.php" method="POST" data-form="default" autocomplete="off">
            <input type="hidden" name="modulo" value="parroquia">
            <div class="container-fluid">
                    ...
                    <div class="col-12 col-md-12">
                        <div class="form-group form-animate-text">
                            ...
                            <span class="bar"></span>
                            <label for="inputSearch" class="bmd-label-floating text-center">¿Qué parroquia estas buscando?</label>
                        </div>
                    </div>
                    <div class="col-12">
            ...
            <div class="container-fluid">
                    ...
                    <div class="col-12 col-md-12">
                        <p class="text-center" style="font-size: 20px;">
                            Resultados de la busqueda <strong>"<?php echo $_SESSION['busqueda_parroquia']; ?>"</strong>
                        </p>
                    </div>
                    <div class="col-12">
    ...
    <div class="container-fluid">
        ...
        echo $ins_parroquia->paginador_parroquia_controlador($pagina[1], 10, $_SESSION['privilegio_tor'], $pagina[0], $_SESSION['busqueda_parroquia']);
        ?>
    </div>
