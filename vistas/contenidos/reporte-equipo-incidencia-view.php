...
<div class="panel box-shadow-none content-header">
    <div class="panel-body">
        <div class="col-md-12">
            <h3 class="animated fadeInLeft">Reportes / Mantenimientos de Activos Informaticos</h3>
            <p class="animated fadeInDown">
                Reporte de historicos de mantenimientos realizados a la plataforma tecnologica de la organización, el formato final es de tipo .pdf.
            </p>
        </div>
    </div>
</div>
...
<div class="container-fluid">
    <form class="form-neon" action="<?php echo SERVERURL; ?>reporte/reporteactivoactividad.php" method="POST" data-form="save" autocomplete="off">
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-md-6">
                        <div class="form-group">
                            <label for="actividad_estado" class="bmd-label-floating" style="color:#1F618D;"><b>ACTIVO INFORMATICO</b></label>
                             <select class="form-control" name="producto_id" id="producto_id" required="">
                                ...
                                if($rs_producto->rowCount()>0){
                                    $datos_productos = $rs_producto->fetchAll();
                                    
                                    foreach($datos_productos as $rows){
                                        echo '<option value="'.$ins_producto->encryption($rows['producto_id']).'">'.$rows['producto_nombre'].' - COD. '.$rows['producto_codigo']. '</option>';
                                    }
                                }
                                ?>
