...
<div class="panel box-shadow-none content-header">
    <div class="panel-body">
        <div class="col-md-12">
            <h3 class="animated fadeInLeft">Evaluacion / Retroalimentacion del sistema</h3>
            <p class="animated fadeInDown">
                <a href="<?php echo SERVERURL; ?>home/">Resumen <span class="fa-angle-right fa"></span></a>
                
                <a href="<?php echo SERVERURL; ?>evaluacion-list/">Lista de Evaluaciones <span class="fa-angle-right fa"></span></a>
                <a href="<?php echo SERVERURL; ?>evaluacion-search/">Buscar Evaluacion <span class="fa-angle-right fa"></span></a>
            </p>
        </div>
    </div>
</div>
...
<?php
if (!isset($_SESSION['busqueda_evaluacion']) && empty($_SESSION['busqueda_evaluacion'])) {
//el empty() para saber si esta vacia y el isset() para saber si esta definida
    ?>
        ...
        <form class="cmxform FormularioAjax" action="<?php echo SERVERURL; ?>ajax/buscadorAjax.php" method="POST" data-form="default" autocomplete="off">
            <input type="hidden" name="modulo" value="evaluacion">
            <div class="container-fluid">
                    ...
                    <div class="col-12 col-md-12">
                        <div class="form-group form-animate-text">
                            ...
                            <span class="bar"></span>
                            <label for="inputSearch" class="bmd-label-floating text-center">¿Qué evaluacion estas buscando?</label>
                        </div>
                    </div>
                    <div class="col-12">
            ...
            <div class="container-fluid">
                    ...
                    <div class="col-12 col-md-12">
                        <p class="text-center" style="font-size: 20px;">
                            Resultados de la busqueda <strong>"<?php echo $_SESSION['busqueda_evaluacion']; ?>"</strong>
                        </p>
                    </div>
                    <div class="col-12">
    ...
    <div class="container-fluid">
        ...
        $ins_evaluacion = new solicitudControlador();
        echo $ins_evaluacion->paginador_evaluacion_controlador($pagina[1], 10, $_SESSION['privilegio_tor'], $pagina[0], $_SESSION['busqueda_evaluacion']);
        ?>
    </div>
