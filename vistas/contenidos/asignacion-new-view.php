...
<div class="panel box-shadow-none content-header">
    <div class="panel-body">
        <div class="col-md-12">
            <h3 class="animated fadeInLeft">Asignacion / Seleccionar una actividad</h3>
...
<?php
if (!isset($_SESSION['busqueda_asignacion']) && empty($_SESSION['busqueda_asignacion'])) {
//el empty() para saber si esta vacia y el isset() para saber si esta definida
    ?>
        ...
        <form class="cmxform FormularioAjax" action="<?php echo SERVERURL; ?>ajax/buscadorAjax.php" method="POST" data-form="default" autocomplete="off">
            <input type="hidden" name="modulo" value="asignacion">
...
echo $ins_solicitud->paginador_solicitud_seleccionar_controlador($pagina[1], 10, $_SESSION['privilegio_tor'], $pagina[0], "");
?>
</div>
            ...
            <div class="container-fluid">
                    ...
                    <div class="col-12 col-md-12">
                        <p class="text-center" style="font-size: 20px;">
                            Resultados de la busqueda <strong>"<?php echo $_SESSION['busqueda_asignacion']; ?>"</strong>
                        </p>
                    </div>
                    <div class="col-12">
    ...
    <div class="container-fluid">
        ...
        require_once "./controladores/solicitudControlador.php";
        $ins_solicitud = new solicitudControlador();
        echo $ins_solicitud->paginador_solicitud_seleccionar_controlador($pagina[1], 10, $_SESSION['privilegio_tor'], $pagina[0], $_SESSION['busqueda_asignacion']);
        ?>
    </div>
