...
<div class="panel box-shadow-none content-header">
    <div class="panel-body">
        <div class="col-md-12">
            <h3 class="animated fadeInLeft">Reportes / Direcciones vs Actividades</h3>
            <p class="animated fadeInDown">
                Totalizacion de las actividades dentro de un rango, seleccionando una direccion, todas o una actividad en especifico, el formato final es de tipo .pdf.
            </p>
        </div>
    </div>
</div>
...
<div class="container-fluid">
    <form class="form-neon" action="<?php echo SERVERURL; ?>reporte/reportedireccionactividad.php" method="POST" data-form="save" autocomplete="off">
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-md-6">
                        <div class="form-group">
                            <label for="actividad_estado" class="bmd-label-floating" style="color:#1F618D;"><b>DIRECCIONES</b></label>
                             <select class="form-control" name="gabinete_id" id="gabinete_id" required="">
                                ...
                                $rs_gabinete = $ins_gabinete->datos_direccion_controlador("Todos", 0);
                                if($rs_gabinete->rowCount()>0){
                                    $datos_gabinetes = $rs_gabinete->fetchAll();
                                    
                                    foreach($datos_gabinetes as $rows){
                                        echo '<option value="'.$ins_gabinete->encryption($rows['direccion_id']).'">'.$rows['direccion_nombre']. '</option>';
                                    }
                                }
                                ?>
