...
<div class="panel box-shadow-none content-header">
    <div class="panel-body">
        <div class="col-md-12">
            <h3 class="animated fadeInLeft">Gabinete / Editar</h3>
...
<div class="container-fluid">
    ...
    $datos_gabinete = $ins_gabinete->datos_gabinete_controlador("Unico", $pagina[1]);

    if($datos_gabinete->rowCount()==1){
        $campos = $datos_gabinete->fetch();
    ?>

    <form class="form-neon FormularioAjax" action="<?php echo SERVERURL; ?>ajax/gabineteAjax.php" method="POST" data-form="update" autocomplete="off">
        <input type="hidden" name="gabinete_id_up" value="<?php echo $pagina[1];?>">
        <fieldset>
            <legend><li class="fa-black-tie fa"></li> &nbsp; Información de la gabinete</legend>
            <div class="container-fluid">
                <div class="row">
                    ...
                    <label for="gabinete_nombre">Nombre</label>
                        <div class="form-group form-animate-text" style="margin-top:20px !important;">
                            <input type="text" pattern="[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ().,#\- ]{2,150}" class="form-text" name="gabinete_nombre_up" id="gabinete_nombre" value="<?php echo $campos['gabinete_nombre']; ?>" maxlength="150" required="">
                            <span class="bar"></span>
