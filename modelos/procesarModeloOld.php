...
class procesarModeloOld extends mainModel {
...
/* Fin Modelo agregar asignacion */
    ...
    protected static function actualizar_operador_home_anual_modelo($datos) {
        $sql = mainModel::conectar()->prepare("UPDATE home_operador SET home_operador_cantidad_anual=home_operador_cantidad_anual + :Cantidad, home_operador_porcentaje_anual = home_operador_porcentaje_anual + :Porcentaje WHERE home_operador_year=:Year AND usuario_id=:Operador");
    ...
    protected static function actualizar_operador_home_mes_modelo($datos) {
        $sql = mainModel::conectar()->prepare("UPDATE home_operador SET home_operador_cantidad_mensual=home_operador_cantidad_mensual + :Cantidad, home_operador_porcentaje_mensual = home_operador_porcentaje_mensual + :Porcentaje WHERE home_operador_year=:Year AND usuario_id=:Operador");
    ...
    protected static function actualizar_operador_home_mes_diferente_modelo($datos) {
        $sql = mainModel::conectar()->prepare("UPDATE home_operador SET home_operador_cantidad_mensual= :Cantidad, home_operador_porcentaje_mensual = :Porcentaje, home_operador_fecha= :Fecha WHERE home_operador_year=:Year AND usuario_id=:Operador");
    ...
    protected static function actualizar_operador_home_dia_modelo($datos) {
        $sql = mainModel::conectar()->prepare("UPDATE home_operador SET home_operador_cantidad_diario=home_operador_cantidad_diario + :Cantidad, home_operador_porcentaje_diario = home_operador_porcentaje_diario + :Porcentaje WHERE home_operador_year=:Year AND usuario_id=:Operador");
    ...
    protected static function actualizar_operador_home_dia_diferente_modelo($datos) {
        $sql = mainModel::conectar()->prepare("UPDATE home_operador SET home_operador_cantidad_diario= :Cantidad, home_operador_porcentaje_diario = :Porcentaje, home_operador_fecha= :Fecha WHERE home_operador_year=:Year AND usuario_id=:Operador");
